...
def init_db():
    ...
    with engine.connect() as conn:
        ...
        _add_column_if_missing(conn, "phone_configs", "vpn_port",                        "INTEGER DEFAULT 1194")
        _add_column_if_missing(conn, "phone_configs", "vpn_transport",                   "TEXT DEFAULT 'udp'")
        _add_column_if_missing(conn, "phone_configs", "vpn_cipher",                      "TEXT DEFAULT 'AES256GCM'")
        _add_column_if_missing(conn, "phone_configs", "vpn_ca",                          "TEXT DEFAULT ''")
        _add_column_if_missing(conn, "phone_configs", "vpn_cert",                        "TEXT DEFAULT ''")
        _add_column_if_missing(conn, "phone_configs", "vpn_client_key",                  "TEXT DEFAULT ''")
