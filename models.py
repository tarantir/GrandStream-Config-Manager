...
class PhoneConfig(Base):
    ...
    hotdesking_server = Column(Text, default="192.168.1.1")
    hotdesking_type = Column(Text, default="TFTP")
    wifi_enabled = Column(Boolean, default=True)
    wifi_band = Column(Text, default="Auto")
    wallpaper_color = Column(Text, default="#000000")
    wallpaper_source = Column(Text, default="ColorBackground")
    screensaver_enabled = Column(Boolean, default=False)
    screensaver_source = Column(Text, default="Default")
    screensaver_timeout = Column(Integer, default=3)
    screensaver_showdatetime = Column(Boolean, default=True)
    screensaver_serverpath = Column(Text, default="")
    screensaver_downloadxmlinterval = Column(Integer, default=0)
    screensaver_useprogrammablekeys = Column(Boolean, default=False)
